...
**Status**: Major revision requested — all reviewer items addressed and `reviews/response-letter.md` finalized; pending a final read-through before resubmission.
