Project title: What Beliefs are Central in the Climate Change Belief System Network?
Project name: climate-beliefs

This is an academic article examining the climate change belief system as a network, incorporating cultural worldviews, political ideology, environmental orientation, perceived scientific consensus, and climate policy preferences into a Gaussian graphical model to identify which beliefs are most central. You are to help me with the R code and managing the github repository for this project. All text for the manuscript will be generated by me. 
...
1. Copy all contents from the project-files directory here: _hidden_.
