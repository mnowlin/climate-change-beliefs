...
# Scans the manuscript source for citation keys and writes a trimmed,
...
# manuscript directory (where climate-beliefs.qmd lives).
...
out_bib <- "manuscript/references.bib"
out_csl <- "manuscript/american-political-science-association.csl"

# --- 1. Collect citation keys from the manuscript source -------------------
src <- c("manuscript/climate-beliefs.qmd")
