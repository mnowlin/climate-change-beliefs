...
Additionally, deep core beliefs are central beliefs in the @converseNatureBeliefSystems1964a sense and, therefore, are resistant to change. Finally, they act as filters for how information about policy issues is processed [@kahanCulturalCognitionConception2012; @nowlinPolicyLearningInformation2021]. 
...
A recent study used a network approach to examine climate change beliefs and found that how worried respondents are about climate change, a policy core belief, was the most central belief in the climate change belief network [@leeClimateChangeBelief2024]. Additionally, support for regulating greenhouse gas emissions (secondary belief/policy preference) and beliefs about potential harm resulting from climate change (policy core belief) also scored high on measures of network centrality. While this study provided important insights into the climate change belief system of the US public, it did not include measures of many deep core beliefs shown to be important influences of climate change beliefs, including cultural worldviews and environmental orientation. 

## Hypotheses

Several hypotheses can be derived regarding the centrality of the various beliefs in the climate change belief network based on previous research. First, deep core beliefs such as cultural worldviews, political beliefs, and pro-environmental orientation shape and constrain other beliefs and, therefore, would have the highest levels of centrality in the network. 

> **H1**: Deep core beliefs will be the most central beliefs in the network 

A second expectation, derived from the work on the scientific consensus acting as a gateway belief, is that views on the scientific consensus would be the most central belief, specifically betweenness centrality. 

> **H2**: Beliefs about the scientific concensus will be the most central belief in the network 

Finally, a third expectation, based on solution aversion, is that the beliefs about policy approaches to climate change would have the highest degree of centrality because support or opposition to policy is what influences other climate beliefs. 
...
In the following analysis, I first examine the climate change belief network, which includes deep core beliefs (cultural worldviews, ideology, partisanship, NEP scale), policy core beliefs (climate change is happening, climate change risk, scientific consensus), and secondary beliefs/policy preference (support for various policy measures). Then, I explore betweenness, closeness, and strength centrality measures of the nodes in the climate change belief network to see which beliefs are the most central.  
...
Political beliefs, cultural worldviews, and pro-environmental orientation have been shown in previous research to shape how the public understands climate change. These types of core beliefs connect to climate change beliefs and views about climate policy to form a climate change belief system. One way to understand belief systems is through a hierarchical approach in which one type of foundational, abstract belief influences other types of beliefs about specific issues and policy approaches. Another, complementary, way of understanding the structures of belief systems is a network where beliefs are the nodes and connections between beliefs are the edges.

In this paper, I used original survey data from a quota-based sample of the US public to examine the belief system network associated with climate change. Additionally, I drew on the leading influences of climate change views identified in the literature, including political beliefs, cultural worldviews, pro-environment orientation, acceptance of the scientific consensus, and solution aversion, to examine which beliefs were the most central in the network.

The results matched some of the expectations regarding the centrality of different types of beliefs within the climate change belief network. Looking at the centrality measures for the entire sample, I found that cultural worldviews (deep core belief), support for various policy approaches (secondary beliefs), and perceptions of the risks posed by climate change (policy core belief) were the most central types of beliefs in the network. These findings support expectations regarding core beliefs (H1), particularly cultural worldviews, as well as expectations of solution aversion (H3). However, less support is found for the scientific consensus as a gateway belief expectation as agreement with the scientific consensus did not have a high level of centrality across any of the measures. If the scientific consensus was a “gateway belief” it would have likely had a high level of betweenness centrality. 
...
The results shown here illustrate the centrality of beliefs across the entire sample; however, it is possible that some subgroups have different belief networks with different beliefs being more (or less) central than the aggregate. For example, @caminaHubsBeliefNetworks2022 found that the structure of belief system networks varied across different subgroups including liberals and conservatives; younger and older; and male and female. Looking at climate change specifically, @leeClimateChangeBelief2024 compared the belief system networks of Democrats and Republicans and found that they had a similar structure and density compared to independents and those with no party affiliation. Additionally, @stewartMappingRacialEthnic2024 found differences in network structure and belief centrality across racial groups, including White, Black, and Hispanic. Additional research with a larger sample size should examine possible differences in network across the various cultural types.    
